...
const uiRowStyle: React.CSSProperties = {
  display: 'flex', justifyContent: 'space-between', marginBottom: '8px', alignItems: 'center',
}
      ...
      {hasData && (
        <div style={uiContainerStyle}>
          ...
          <div style={uiRowStyle}>
            <span>
              Час:{' '}
              <b>{(((flightData[currentIndex]?.TimeUS ?? 0) - flightData[0].TimeUS) / 1_000_000).toFixed(2)} с</b>
            </span>
            <span>
              Швидкість: <b>{flightData[currentIndex]?.v_mag?.toFixed(2)} м/с</b>
            </span>
          </div>
